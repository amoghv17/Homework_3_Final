...
def a_star_quadtree(start_m, goal_m, qtm, movement='8n', occupancy_cost_factor=3):
    ...
    start_node_cost = 0
    start_node_est_cost_to_goal = quadtreemap.Point.disOf2Points(start.getCenter(), goal.getCenter()) + start_node_cost
    front = [(start_node_est_cost_to_goal, start_node_cost, start, None)]
